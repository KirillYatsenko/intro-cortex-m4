...
uint8_t h_char[] = {0x1F, 0x04, 0x1F, 0x00};
uint8_t e_char[] = {0x1F, 0x15, 0x15, 0x00};
uint8_t l_char[] = {0x1F, 0x10, 0x10, 0x00};
uint8_t o_char[] = {0x1F, 0x11, 0x1F, 0x00};
uint8_t space_char[] = {0x00, 0x00};
uint8_t w_char[] = {0x0F, 0x10, 0x0E, 0x10, 0x0F, 0x00};
uint8_t r_char[] = {0x1F, 0x09, 0x16, 0x00};
uint8_t d_char[] = {0x1F, 0x11, 0x11, 0x0E, 0x00};
uint8_t exclam_char[] = {0x17, 0x00};
